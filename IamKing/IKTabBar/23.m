...
//    [self.tabBar removeFromSuperview];  //移除TabBarController自带的下部的条
    ...
    IKTabBar *tabBar = [[IKTabBar alloc] initWithFrame:self.tabBar.frame];
    ...
    UIView *line = [[UIView alloc] initWithFrame:CGRectMake(0, self.tabBar.frame.origin.y, IKSCREEN_WIDTH, 1)];
